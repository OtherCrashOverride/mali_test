all:
	g++ -g -std=c++11 -O2 test_window.cpp X11Window.cpp Egl.cpp -o test_window -L/usr/lib/arm-linux-gnueabihf/mali-egl/ -lmali
#	g++ -g -std=c++11 -O2 test_vsync.cpp X11Window.cpp Egl.cpp -o test_vsync -I/usr/include/libdrm -L/usr/lib/arm-linux-gnueabihf/mali-egl/ -lmali -lX11 -ldrm
